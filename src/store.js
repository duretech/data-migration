...
const defaultState = {
  ...
  isAnnualEMUSet: true,
  namespace: settings.tableName || "data_migration",
};
...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setSecondaryServerAuth(state, payload) {
      state.secondaryServerAuth = payload;
    },
    setSecondaryHeader(state, payload) {
      state.secondaryHeader = payload;
    },
    setSecondaryServerUrl(state, payload) {
      state.secondaryServerUrl = payload;
    },
  ...
  getters: {
    ...
    getSecondaryServerAuth(state) {
      return state.secondaryServerAuth;
    },
    getSecondaryHeader(state) {
      return state.secondaryHeader;
    },
    getSecondaryServerUrl(state) {
      return state.secondaryServerUrl;
    },
    getBaseURL(state) {
    ...
    getDataSetList(state) {
      return state.dataSetList
        ? process.env.NODE_ENV !== "production"
          ? state.dataSetList
          : JSON.parse(LZString.decompressFromUTF16(state.dataSetList))
        : null;
    },
